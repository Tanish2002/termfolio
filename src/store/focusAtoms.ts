...
export const registeredDivsAtom = atom<Map<number, React.RefObject<HTMLDivElement>>>(new Map());
export const registeredItemsAtom = atom<Map<number, Map<number, React.RefObject<HTMLDivElement>>>>(
	new Map()
);

...
const getDynamicIconImports = () => ({
  ci: (icon: string) =>
    import("react-icons/ci").then(
      (mod) => mod[icon as keyof typeof mod] as IconType,
    ),
  fa6: (icon: string) =>

...
const IconFamilies = {
  ci: dynamic(() =>
    import("react-icons/ci").then((mod) => {
  ...
  ti: dynamic(() =>
    import("react-icons/ti").then((mod) => {
  ...
  go: dynamic(() =>
    import("react-icons/go").then((mod) => {
  ...
  wi: dynamic(() =>
    import("react-icons/wi").then((mod) => {
  ...
  di: dynamic(() =>
    import("react-icons/di").then((mod) => {
  ...
  hi2: dynamic(() =>
    import("react-icons/hi2").then((mod) => {
  ...
  sl: dynamic(() =>
    import("react-icons/sl").then((mod) => {
  ...
  im: dynamic(() =>
    import("react-icons/im").then((mod) => {
  ...
  cg: dynamic(() =>
    import("react-icons/cg").then((mod) => {
  ...
  tfi: dynamic(() =>
    import("react-icons/tfi").then((mod) => {

...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_projects_project_type" AS ENUM('web development', 'mobile development', 'desktop application', 'native mobile app', 'hybrid mobile app', 'cross platform app', 'enterprise software', 'backend service', 'api service', 'microservice', 'cloud infrastructure', 'data pipeline', 'machine learning', 'ai application', 'data visualization', 'cli tool', 'browser extension', 'automation tool', 'development tool', 'open-source library', 'open-source contribution', 'iot application', 'research prototype');
  CREATE TYPE "public"."enum_projects_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__projects_v_version_project_type" AS ENUM('web development', 'mobile development', 'desktop application', 'native mobile app', 'hybrid mobile app', 'cross platform app', 'enterprise software', 'backend service', 'api service', 'microservice', 'cloud infrastructure', 'data pipeline', 'machine learning', 'ai application', 'data visualization', 'cli tool', 'browser extension', 'automation tool', 'development tool', 'open-source library', 'open-source contribution', 'iot application', 'research prototype');
  CREATE TYPE "public"."enum__projects_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum_techstacks_logo_family" AS ENUM('ci', 'fa6', 'io', 'io5', 'md', 'ti', 'go', 'fi', 'gi', 'wi', 'di', 'ai', 'bs', 'ri', 'pi', 'fc', 'gr', 'hi', 'hi2', 'si', 'sl', 'im', 'bi', 'cg', 'vsc', 'tb', 'tfi');
  CREATE TYPE "public"."enum_socials_logo_family" AS ENUM('ci', 'fa6', 'io', 'io5', 'md', 'ti', 'go', 'fi', 'gi', 'wi', 'di', 'ai', 'bs', 'ri', 'pi', 'fc', 'gr', 'hi', 'hi2', 'si', 'sl', 'im', 'bi', 'cg', 'vsc', 'tb', 'tfi');
  CREATE TYPE "public"."enum_users_roles" AS ENUM('admin', 'viewer');
  ...
  CREATE TABLE IF NOT EXISTS "_projects_v" (
  	...
  	"parent_id" integer,
  	"version_title" varchar,
  	"version_project_banner_id" integer,
  	"version_content" jsonb,
  ...
  CREATE TABLE IF NOT EXISTS "techstacks" (
  	...
  	"logo_family" "enum_techstacks_logo_family" DEFAULT 'ci' NOT NULL,
  ...
  CREATE TABLE IF NOT EXISTS "socials" (
  	...
  	"enabled" boolean DEFAULT true,
  	"logo_family" "enum_socials_logo_family" DEFAULT 'ci' NOT NULL,
  	"logo_name" varchar NOT NULL,
  	"updated_at" timestamp(3) with time zone DEFAULT now() NOT NULL,
  	"created_at" timestamp(3) with time zone DEFAULT now() NOT NULL
  );
  ...
  DO $$ BEGIN
   ALTER TABLE "projects" ADD CONSTRAINT "projects_project_banner_id_media_id_fk" FOREIGN KEY ("project_banner_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  DO $$ BEGIN
   ALTER TABLE "_projects_v" ADD CONSTRAINT "_projects_v_version_project_banner_id_media_id_fk" FOREIGN KEY ("version_project_banner_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "experiences_slug_idx" ON "experiences" USING btree ("slug");
  ...
  CREATE INDEX IF NOT EXISTS "experiences__status_idx" ON "experiences" USING btree ("_status");
  CREATE INDEX IF NOT EXISTS "_experiences_v_parent_idx" ON "_experiences_v" USING btree ("parent_id");
  CREATE INDEX IF NOT EXISTS "_experiences_v_version_version_slug_idx" ON "_experiences_v" USING btree ("version_slug");
  CREATE INDEX IF NOT EXISTS "_experiences_v_version_version_updated_at_idx" ON "_experiences_v" USING btree ("version_updated_at");
  CREATE INDEX IF NOT EXISTS "_experiences_v_version_version_created_at_idx" ON "_experiences_v" USING btree ("version_created_at");
  CREATE INDEX IF NOT EXISTS "_experiences_v_version_version__status_idx" ON "_experiences_v" USING btree ("version__status");
  CREATE INDEX IF NOT EXISTS "_experiences_v_created_at_idx" ON "_experiences_v" USING btree ("created_at");
  CREATE INDEX IF NOT EXISTS "_experiences_v_updated_at_idx" ON "_experiences_v" USING btree ("updated_at");
  CREATE INDEX IF NOT EXISTS "_experiences_v_latest_idx" ON "_experiences_v" USING btree ("latest");
  CREATE INDEX IF NOT EXISTS "_experiences_v_autosave_idx" ON "_experiences_v" USING btree ("autosave");
  CREATE INDEX IF NOT EXISTS "projects_project_banner_idx" ON "projects" USING btree ("project_banner_id");
  ...
  CREATE INDEX IF NOT EXISTS "_projects_v_version_version_project_banner_idx" ON "_projects_v" USING btree ("version_project_banner_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_techstacks_logo_family";
  DROP TYPE "public"."enum_socials_logo_family";
